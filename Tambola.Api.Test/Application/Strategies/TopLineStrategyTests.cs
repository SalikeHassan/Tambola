...
public class TopLineStrategyTests
{
    private readonly TopLineStrategy strategy;

    public TopLineStrategyTests()
    {
        strategy = new TopLineStrategy();
    }

    [Fact]
    public void IsWinningCondition_AllNumbersInTopLineAnnounced_ShouldReturnTrue()
    {
        // Arrange
    ...
    [Fact]
    public void IsWinningCondition_NotAllNumbersInTopLineAnnounced_ShouldReturnFalse()
    {
        // Arrange
        var ticket = Ticket.Create(new int?[][]
        {
